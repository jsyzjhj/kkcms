...
<body>
   <form method="post">
    <div class="container wrap1" style="height:680px;">
            <h2 class="mg-b20 text-center">KKCMS安装向导</h2>
            <div class="col-sm-8 col-md-8 center-auto pd-sm-50 pd-xs-20 main_content">
                ...
                <p class="text-left font16">数据库服务器</p>
                    <div class="form-group mg-t10">
                        <input id="db_host" type="text" name="db_host" class="input" placeholder="请输入数据库服务器" value="127.0.0.1"/>
                    </div>
				...
				<p class="text-left font16">数据库名</p>
                    ...
                    <div class="form-group mg-t10">
                        <input id="db_password" name="db_password" type="password" class="input" placeholder="请输入数据库密码" />
                    </div>
					<p class="input-note">按服务器提供商提供的填写</p>
