...
<?php } ?>
 ...
 <?php if ($xtcms_dianshi == 1) { ?>
	<div style="width:100%;height:40px;background:#eee;border-radius:2px;box-show:0 0 -10px #fff;text-align:center;line-height:40px;cursor:pointer;" onclick="document.getElementById('cxyc').style='display:block'">以下是站外尝鲜资源搜索结果,点击展开查看∨</div>
	<div id="cxyc" style="display:none;">
<?php
$link=$zwcx['zhanwai'];
